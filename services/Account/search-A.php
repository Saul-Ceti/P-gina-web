<?php
    ...
    $sql = "SELECT * FROM usuarios WHERE (id_role = 2) AND (names LIKE '%$query%' OR first_lastname LIKE '%$query%' OR second_lastname LIKE '%$query%' OR email LIKE '%$query%')";
        ...
        <ul class="nav-links">
            ...
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <li><a href="user-U.php">Clientes</a></li>
            ...
            <div class="rectification">
                <div class="col-1">
                    ...
                    <div class="search-container">
                        <form action="search-A.php" method="GET">
                            <input type="text" name="query" placeholder="Buscar administradores...">
                ...
                <div class="col-3">
                    <div class="form-box-product">
                        ...
                        <form method="POST" action="admin-UX.php">
